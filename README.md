...
![gradle-plugin](https://img.shields.io/maven-central/v/com.clauto.tools.materialthemebuilder/com.clauto.tools.materialthemebuilder.gradle.plugin?label=gradle-plugin)
...
1. Add gradle plugin
   ...
   buildscript {
       ...
       dependencies {
           classpath 'com.clauto.tools.materialthemebuilder:gradle-plugin:<version>'
       }
   }
   ```
   ...
   // "new way"
   plugins {
       id 'com.clauto.tools.materialthemebuilder' version '<version>'
   }
   ```
...
2. Use the plugin in Android application or library module
   ...
   ```groovy
   plugins {
       id('com.clauto.tools.materialthemebuilder')
   }
   ...
   materialThemeBuilder {
       ...
       themes {
           ...
           theme1 {
               ...
               lightThemeParent = "Theme.Material3.Light.Clauto"
               darkThemeFormat = "Theme.Material3.Dark.%s"
               darkThemeParent = "Theme.Material3.Dark.Clauto"
           }
           theme2 {
               // ...
           }
       ...
       // clauto.material:material >= 2.0.0 provides such attributes
       // Enable this if your are using clauto.material:material
       generatePalette = false
       
       // Generate Material Design 3 color tokens attributes (such as palettePrimary100)
       // When necessary, you can use this if your are not using clauto.material:material
